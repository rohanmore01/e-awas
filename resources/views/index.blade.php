...
<body>
        ...
        <section class="wrapper megamenu-wraper">
            <div class="container common-container four_content">
                ...
                <nav class="main-menu clearfix" id="main_menu">
                    <ul class="nav-menu">
                        <li class="nav-item"> <a href="{{ url('/') }}" class="home"><span
    ...
    <div class="toast active">
        <div class="toast-content">
            <i class="fa fa-bell" style="font-size:25px;color:blue;"></i>

            <div class="message">
                <span class="text">This is for Notification</span>
            </div>
        </div>
    ...
    <section class="wrapper banner-wrapper">
        <div id="flexSlider" class="flexslider">
            <ul class="slides">
                <li> <img src="{{ asset('theme/images/banner/1.jpg') }}" alt="slide 1"></li>
                <li> <img src="{{ asset('theme/images/banner/2.jpg') }}" alt="slide 2"></li>
                <li> <img src="{{ asset('theme/images/banner/3.jpg') }}" alt="slide 3"></li>
            </ul>
        </div>
    </section>
                    ...
                    <div class="notification-mid">
                        <ul class="slides">
                            <li>
                                <span>
                                    NEW-
                                    <h3>Description of News 1 goes here - mm-dd-yyyy. </h3>
                                </span>
                            </li>
                            <li>
                                <span>
